...
Namespace GearsTest
    ...
    Public Class GearsMediatorTest
        ...
        Public Sub makeBranchByControl()
            ...
            conTree.Add("pnlGFORM", New List(Of String) From {"txtNAME", "ddlAREA", "ddlDEPT"})
            conTree.Add("grvDATA", Nothing)

            Dim root As Control = ControlBuilder.makeControl(RelationNode.makeTree(conTree))
            ...
            mediator.addRelation("ddlAREA", "ddlDEPT") '地域->組織へフィルタをかけるリレーションを追加
            ...
            'txtNAME->grvDATA,ddlAREA->ddlDEPTの2件になる
