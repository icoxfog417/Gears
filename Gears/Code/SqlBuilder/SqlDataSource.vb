...
Namespace Gears
    ...
    Public Class SqlDataSource
        ...
        Public Sub New(ByVal ds As SqlDataSource)
            ...
            Me._value = New Dictionary(Of String, Object)(ds.getValue)
        ...
        Public Function getRelKey(ByVal relate As String) As List(Of SqlFilterItem)
            ...
            End If
        End Function
        Public Function getValue() As Dictionary(Of String, Object)
            Return _value
        End Function
        Public Sub getValue(ByRef params As Dictionary(Of String, Object))
